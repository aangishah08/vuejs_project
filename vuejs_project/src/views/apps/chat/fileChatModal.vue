<template>
  ...
  >
    ...
    >
     <b> <b-form-radio value="first" >Root Folder</b-form-radio>
      <b-form-radio value="second" >Other Folder</b-form-radio></b>
        ...
        >
          <template #list-footer>
            <li ref="load" class="loader text-center">
              <b-spinner v-if="isOptionLoading" variant="light" />
            </li>
          </template>
        </v-select>
...
<script>
import {
  BFormInput, BModal, BFormGroup, BForm, BButton,BFormFile,BFormRadioGroup,BFormRadio,BDropdown,BDropdownItem,BSpinner
} from 'bootstrap-vue'
  ...
  methods: {
    insertFileData()
    {
      ...
      requestData.set('parentFolderId',this.currentFolderId)
        ...
        requestData.set('parentFolderId', this.selectedId)
      }
    ...
    async loadFolderOptions([{ isIntersecting, target }]) {
