  ...
  >
    <template>
      ...
      <div class="modal-body-content" v-if="viewFileDetails.isPdfFile">
        <vue-pdf-embed class="pdf-view-content" :source="fileURL" /></div>
      <div   v-else-if="viewFileDetails.isImageFile"   class="d-flex align-items-center justify-content-center h-100">
        <img class="w-100 h-50" :src="fileURL" alt="Image Document" /></div>
...
import { downloadFile, readFileContent } from '@/views/pages/authentication/services/login'
import VuePdfEmbed from 'vue-pdf-embed/dist/vue2-pdf-embed'
import  {codemirror} from 'vue-codemirror'
export default {
  name: 'show-read-file-modal',
  components: {
    BFormInput,
    BModal,
    BFormGroup,
  ...
  beforeMount() {
    this.showModal = this.showReadFileModal
